  ...
  return (
    <div className="landing-container">
      ...
      <div>
        ...
        <div>
            <img className={classes.image} src="https://images.unsplash.com/photo-1661961110144-12ac85918e40?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" />
        </div>
            ...
            <>
              <div className={`${classes.articleContainer} `}>
                ...
                <div className={classes.imageContainer}>
                    <img className={classes.img} src="https://images.unsplash.com/photo-1661961110144-12ac85918e40?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" />
                    <button className={`${classes.button} bg-primary text-white`}>Read More</button>
                </div>
              </div>
            </>
          );
